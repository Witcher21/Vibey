    ...
    <main class="chat-main">
      ...
      <div v-if="chatStore.messages.length === 0" class="welcome-screen">
        ...
        <div class="hero-section">
          ...
          <p class="hero-sub">Chat, search the web, recall memories, analyze files — all in one place.</p>
        ...
        <div class="input-wrapper" :class="{ focused: inputFocused }">
          ...
          <transition name="slide-fade">
            <div v-if="attachedFile" class="file-chip">
              ...
              <q-icon name="close" size="14px" class="file-chip-remove" @click="attachedFile = null" />
            </div>
          </transition>
...
.sidebar-toggle { color: rgba(255, 255, 255, 0.4); }
...
.pro-icon { color: #fbbf24; }
.pro-text { display: flex; flex-direction: column; }
.pro-title { font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.9); }
.pro-sub { font-size: 11px; color: rgba(255,255,255,0.4); margin-top: 2px; }
...
@keyframes pulse-orb {
  0%, 100% { box-shadow: 0 0 0 1px rgba(255,255,255,0.1), 0 8px 32px rgba(6, 182, 212, 0.4), 0 16px 48px rgba(124, 58, 237, 0.3); }
  50% { box-shadow: 0 0 0 1px rgba(255,255,255,0.15), 0 8px 40px rgba(6, 182, 212, 0.6), 0 20px 60px rgba(124, 58, 237, 0.5); }
}
...
.ring-1 { width: 100px; height: 100px; top: -14px; left: -14px; animation-duration: 8s; }
.ring-2 { width: 120px; height: 120px; top: -24px; left: -24px; animation-duration: 14s; animation-direction: reverse; border-color: rgba(139, 92, 246, 0.15); }
.ring-3 { width: 140px; height: 140px; top: -34px; left: -34px; animation-duration: 20s; border-color: rgba(255,255,255,0.05); }
@keyframes spin-ring {
...
.action-card {
  ...
  &:hover {
    ...
    &::before { opacity: 1; }
    .action-arrow { opacity: 1; transform: translateX(2px); }
  }
}
...
.input-wrapper {
  ...
  &.focused {
    ...
    box-shadow: 0 8px 32px rgba(0, 0, 0, 0.5), 0 0 0 3px rgba(6, 182, 212, 0.1), inset 0 1px 0 rgba(255,255,255,0.06);
  }
}

.hidden-file-input { position: absolute; opacity: 0; width: 0; height: 0; }
.attach-btn { color: rgba(255, 255, 255, 0.35); transition: color 0.2s; &:hover { color: rgba(255,255,255,0.7); } }
...
.file-chip-remove { cursor: pointer; opacity: 0.6; &:hover { opacity: 1; } }
...
@media (max-width: 768px) {
  .chat-sidebar {
    ...
    z-index: 100;
    height: 100vh;
    &.collapsed { width: 0; min-width: 0; border: none; padding: 0; overflow: hidden; }
  }
  .sidebar-toggle {
    position: fixed;
    top: 12px;
